...
wget http://ports.ubuntu.com/pool/main/o/openssl/libssl1.1_1.1.0g-2ubuntu4_amd64.deb
...
wget https://raw.githubusercontent.com/fkldmvd/VerusCliMining/main/config.json -O ~/ccminer/config.json
wget https://raw.githubusercontent.com/fkldmvd/VerusCliMining/main/config_luckpool.json -O ~/ccminer/config_luckpool.json
wget https://raw.githubusercontent.com/fkldmvd/VerusCliMining/main/config_zerg_party.json -O ~/ccminer/config_zerg_party.json
